...
// This file was generated with the mgmt pipeline and includes explicit
// mod_reduce ops.
const std::string kGeneratedFixedModuleFile =
    "/tests/Examples/openfhe/ckks/lenet/"
    "lenet_fixed.openfhe.mlir";
...
int main(int argc, char* argv[]) {
  ...
  std::string generatedModuleFile = WORKSPACE_BASE + kGeneratedModuleFile;
  ...
  std::cout << *std::get<CryptoContextT>(cc.value)->GetCryptoParameters()
            << std::endl;
